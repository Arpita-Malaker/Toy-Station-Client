...
const Home = () => {
  ...
  <div className="hero-content text-center ">
    <div className="max-w ">
      <h1 className="mb-5 text-5xl font-bold">Wellcome to <span className=' text-yellow-500	 '>Toy Station</span></h1>
      <p className="mb-5 ml-10 max-w-md">Welcome to Toy Station – your #1 hotspot for brilliant toys, infant items, diversions, kids’ toy and  music toy and more.

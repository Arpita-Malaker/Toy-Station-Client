...
const Home = () => {
  ...
  <div className="hero-content text-center ">
    <div className="max-w ">
      <h1 data-aos="fade-left" data-aos-duration="3000" className="mb-5 text-5xl text-yellow-500 font-bold">Wellcome to <span className=' text-yellow-500	 '>Toy Station</span></h1>
      <p data-aos="fade-right" data-aos-duration="3000" className="mb-5 ml-10 max-w-md text-yellow-100">Welcome to Toy Station – your #1 hotspot for brilliant toys, infant items, diversions, kids’ toy and  music toy and more.
